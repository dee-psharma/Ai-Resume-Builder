...
const ResumeBuilder = () => {
  ...
  const section = [
    ...
    { id: "experiance", name: "Experiance", icon: BriefcaseIcon },
              ...
              <div className="flex items-center gap-2">
                {activeSectionIndex !== 0 && (
                  <button
                    ...
                    className="flex items-centre gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all "
