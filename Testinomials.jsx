...
const Testinomials = () => {
  ...
  return (
    <>
         <div id='testinomials' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title="Don't just take our words" description="Hear what our users say about us.We're always looking for ways to improve. If you have a positive exprerience with us, leave a review." />
